<template>
  <div v-if="pokemon == undefined" class="no-pokemon-container">
    <h3 style="text-align:center">This pokemon doesn't exist!</h3>
  </div>
  <div v-else>
      ...
      <div id="right-div">
        <div id="strengths-details">
          ...
          <div class="listings-container">
            <div
              v-for="(item, i) in pkmnStrengthWeakness"
              :key="i"
              class="card"
            >
...
export default {
  ...
  head() {
    ...
    this.pokemon == undefined
      ? (title = "")
      : (title = `- ${this.pokemon.name[0].toUpperCase()}${this.pokemon.name
          .slice(1)
          .toLowerCase()}`);
